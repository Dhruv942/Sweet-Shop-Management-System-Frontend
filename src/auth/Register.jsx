...
function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden py-8">
          ...
          <div className="mt-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label
                  htmlFor="email"
                  className="block text-sm font-bold text-gray-200 uppercase tracking-wide"
                >
                  Email Address
                </label>
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-gray-300">
                ...
                <a
                  href="#"
                  className="text-purple-300 hover:text-pink-300 font-bold transition-colors duration-200 hover:underline"
                >
                  Sign in here
                </a>
              </p>
